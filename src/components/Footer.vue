      ...
      <div
        ...
        <div class="space-y-1 text-center md:text-left">
          ...
          <p class="flex items-center justify-center gap-1 md:justify-start">
            <a
              href="https://github.com/LTXWorld/viva-faka-user"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="VivaStore on GitHub"
...
const wechatId = 'EDGzedzzz'

const brandSiteName = computed(() => {
  const siteName = config.value?.brand?.site_name
  return typeof siteName === 'string' && siteName.trim() ? siteName.trim() : 'VivaStore'
})
