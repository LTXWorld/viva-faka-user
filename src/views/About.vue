    ...
    <div class="container mx-auto px-4 max-w-4xl">
      ...
      <div
        ...
        <div v-if="hasContact">
          ...
          <div v-if="hasContactLinks" class="grid grid-cols-1 gap-4">
            <div
              class="group flex items-center justify-center space-x-3 theme-surface-soft border theme-border theme-text-secondary px-6 py-4 rounded-xl">
              <svg class="w-6 h-6 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 4v-4z" />
              </svg>
              <span class="font-bold">微信：{{ wechatId }}</span>
            </div>
          </div>
        </div>
      </div>
...
const wechatId: string = 'EDGzedzzz'
...
const hasContactLinks = computed(() => wechatId.trim() !== '')
